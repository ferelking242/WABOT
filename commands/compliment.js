...
async function complimentCommand(sock, chatId, message) {
    // Define userId once at the beginning for consistent use throughout the function
    const userId = message?.key?.participant || message?.key?.remoteJid || chatId;
    ...
    try {
        ...
        if (!userToCompliment) {
            ...
            const errorMsg = getText(userId, 'MENTION_USER_TO_COMPLIMENT', userLang);
